...
<form method="post">
    ...
    <table>
        <tr>
            ...
            <td><input style="height: 10%; width: 205px; background-color:#23232F; color: white; border-color:#676EFF" type="submit" name="InlogSubmit" value="Registreren" onclick="return confirm('Zijn alle gegevens goed ingevuld en gecontroleerd?')"></td>
        </tr>
    </table>
</form>
<?php
if(isset($_POST["InlogSubmit"])) {
    ...
    if (isset($row[0])) {
        ...
        $query = "INSERT INTO webshopklant VALUES ((SELECT MAX(WebCustomerID)+1 FROM webshopklant w),'".$naam."','".$land."','".$woonplaats."','".$adres."','".$postcode."','".$telnr."','".$email."','".$password."',1)";
        $result = mysqli_query($connection, $query);
