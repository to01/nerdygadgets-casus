...
?>
    <table>
        ...
        <tr> <!--Wachtwoord -->
            ...
            <td><input style="height: 10%; background-color:#23232F; color:#FFFFFF; border-color:#676EFF" name="wachtwoord" type="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" required></td>
        </tr>
        <tr> <!--e-mail -->
    ...
    <table>
        <tr>
            ...
            <td><input style="height: 10%; width: 204.8px; background-color:#23232F; color: white; border-color:#676EFF" type="submit" name="Inlogsubmit" value="Registreren" onclick="return confirm('Zijn alle gegevens goed ingevuld en gecontroleerd?')"></td>
        </tr>
    </table>
</form>
