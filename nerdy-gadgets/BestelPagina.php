...
<form method="post">
    <table>
        ...
        <tr> <!-- Radio -->
            ...
            <td>Particulier:</td>
            <td><input style="height: 10%" type="radio" id="particulier" name="besteller" value="particulier" checked required onload="ShowHideDiv()" onclick="ShowHideDiv()" ></td>
            <td>Zakelijk:</td>
            <td><input style="height: 10%" type="radio" id="zakelijk" name="besteller" value="zakelijk" onclick="ShowHideDiv()"></td>
        </tr>
    </table>
    ...
    <table>
        <tr> <!-- telefoonnummer -->
            ...
            <td><input style="height: 10%; width: 60px; background-color:#23232F; color: white; border-color:#676EFF" type="text" id="phone" name="phone" placeholder="+31" maxlength="4" pattern="+[0,9]{2,3}\[0,9]{2,3}" required></td>
    ...
    <table>
        <tr>
            ...
            <td><input style="height: 10%; width: 204.8px; background-color:#23232F; color: white; border-color:#676EFF" type="submit" name="BestelSubmit" value="Bestellen" onclick="return confirm('Zijn alle gegevens goed ingevuld en gecontroleerd?')"></td>
        </tr>
    </table>
</form>
<?php
