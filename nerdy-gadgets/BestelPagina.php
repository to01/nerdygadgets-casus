...
<?php
if(empty($cart)) {
    print("<h1 style='color: red'>Uw winkelwagen is nog leeg!</h1>");   // checkt of de winkelwagen leeg is en als dit het geval is print het text uit en stopt het je van bestellen
} else {
    ?>
    <br>
    <head>
