...
<table style="width: 100%">
    <tr>
        <td>
            <h1 class="TextMain" style="width: 100%;margin-left: 5px; margin-top: 5px">Gegevens aanpassen</h1>
        </td>
    </tr>
</table>
<form method="post">
    <table>
        <tr> <!--Land -->
            ...
            <td><select name="EditLand" style="height: 7%; width: 55%;background-color:#23232F; color: white; border-color:#676EFF">
                    <?php print($land) ?>
    ...
    <table>
        ...
        <tr> <!-- postcode -->
            ...
            <td><input style="height: 10%; background-color:#23232F; color: white; border-color:#676EFF" name="EditPostcode" type="text" placeholder="<?php print($postcode) ?>" required pattern="[0-9]{4}[A-Z]{2}|[0-9]{4} [A-Z]{2}"></td>
        </tr>
        <table>
            <tr>
                <td style="width: 160px"></td>
                <td><input style="height: 10%; width: 205px; background-color:#23232F; color: white; border-color:#676EFF" type="submit" name="EditSubmit" value="Wijzigingen toepassen" onclick="return confirm('Zijn alle gegevens goed ingevuld en gecontroleerd?')"></td>
            </tr>
        </table>
    </table>
</form>
<?php
if($_SESSION["inlogstatus"]) {
